<?php
    ...
    class TaxControllert extends Controller
    {
        ...
        public function store(StoreTaxRequest $request)
        {
            ...
            $column_800_2000 =  $csv_prepare[0][1];
            $column_2000_7999 =  $csv_prepare[0][2];
            $column_8000_20000 =  $csv_prepare[0][3];
            $column_20000_40000 =  $csv_prepare[0][4];
            $column_40001_80000 =  $csv_prepare[0][5];
            $column_80001_120000 =  $csv_prepare[0][6];
            $column_120001_160000 =  $csv_prepare[0][7];
            $column_160001_240000 =  $csv_prepare[0][8];
            ...
            //TODO Creare le corrette colonne ad db e salvare
        }
