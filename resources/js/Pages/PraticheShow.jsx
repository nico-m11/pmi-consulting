...
export default function PraticheShow({auth,  success, pratiche, tasks, queryParams}) {
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={
        ...
        >
            <Head title={`Project "${pratiche.name}"`}/>
            <div className="py-12">
                            ...
                            <div className="grid gap-1 grid-cols-2 mt-2">
                                <div>
                                    <div>
                                        ...
                                        <p className="mt-1">{pratiche.id}</p>
                                    </div>
                                    <div className="mt-4">
                                        <label className="font-bold text-lg">Project Name</label>
                                        <p className="mt-1">{pratiche.name}</p>
                                    </div>
                                </div>
                            </div>
